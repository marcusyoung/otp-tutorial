...
Create another router called 'new' and include the 'aircoach-gtfs.zip', and the same files used for the 'current' router. Build the graph for this router, and then try running OTP in server mode with both the 'current' and 'new' routers loaded.    
...
You can now import the GeoJSON file into QGIS, using 'the 'Add Vector Layer' and then apply a suitable style. Use the OpenLayers plugin to add a suitable basemap.
